...
# [GCC 9.4.0]
# Embedded file name: libs/bl628/bootheader_cfg_keys.py
clock_start_pos = 100
bootcfg_start_pos = 124
bootcfg_len = 48
bootcpucfg_start_pos = bootcfg_start_pos + bootcfg_len
bootcpucfg_len = 16
bootcpucfg_m0_index = 0
bootcpucfg_m1_index = 1
boot2_start_pos = bootcpucfg_start_pos + bootcpucfg_len * (bootcpucfg_m1_index + 1)
boot2_len = 8
...
crc32_start_pos = patch_on_jump_start_pos + patch_on_jump_len
...
bootheader_cfg_keys = {'magic_code':{'offset':'0', 
 ...
 'xtal_type':{'offset':str(int(clock_start_pos) + 4), 
  'pos':'0', 
  'bitlen':'8'}, 
 'wifipll_pu':{'offset':str(int(clock_start_pos) + 4), 
  'pos':'8', 
  'bitlen':'8'}, 
 'cpupll_pu':{'offset':str(int(clock_start_pos) + 4), 
  'pos':'16', 
  'bitlen':'8'}, 
 'mcu_clk':{'offset':str(int(clock_start_pos) + 4), 
  'pos':'24', 
  'bitlen':'8'}, 
 'mcu_clk_div':{'offset':str(int(clock_start_pos) + 8), 
  'pos':'0', 
  'bitlen':'8'}, 
 'mcu_bclk_div':{'offset':str(int(clock_start_pos) + 8), 
  'pos':'8', 
  'bitlen':'8'}, 
 'wlp2_mcu_clk':{'offset':str(int(clock_start_pos) + 8), 
  'pos':'16', 
  'bitlen':'8'}, 
 'wlp2_mcu_clk_div':{'offset':str(int(clock_start_pos) + 8), 
  'pos':'24', 
  'bitlen':'8'}, 
 'wlp2_mcu_bclk_div':{'offset':str(int(clock_start_pos) + 12), 
  'pos':'0', 
  'bitlen':'8'}, 
 'wlp1_root_clk':{'offset':str(int(clock_start_pos) + 12), 
  'pos':'8', 
  'bitlen':'8'}, 
 'wlp1_root_bclk_div':{'offset':str(int(clock_start_pos) + 12), 
  'pos':'16', 
  'bitlen':'8'}, 
 'flash_clk_type':{'offset':str(int(clock_start_pos) + 12), 
  'pos':'24', 
  'bitlen':'8'}, 
 'flash_clk_div':{'offset':str(int(clock_start_pos) + 16), 
  'pos':'0', 
  'bitlen':'8'}, 
 'rsvd_clk':{'offset':str(int(clock_start_pos) + 16), 
  'pos':'8', 
  'bitlen':'24'}, 
 'clkcfg_crc32':{'offset':str(int(clock_start_pos) + 20), 
  'pos':'0', 
  'bitlen':'32'}, 
 ...
 'hash_ignore':{'offset':str(int(bootcfg_start_pos) + 0), 
  'pos':'17', 
  'bitlen':'1'}, 
 'rsvd_21_18':{'offset':str(int(bootcfg_start_pos) + 0), 
  'pos':'18', 
  'bitlen':'4'}, 
 ...
 'm0_msp_val':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m0_index) + 12), 
  'pos':'0', 
  'bitlen':'32'}, 
 'm1_config_enable':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0), 
  'pos':'0', 
  'bitlen':'8'}, 
 'm1_halt_cpu':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0), 
  'pos':'8', 
  'bitlen':'8'}, 
 'm1_cache_enable':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0), 
  'pos':'16', 
  'bitlen':'1'}, 
 'm1_cache_wa':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0), 
  'pos':'17', 
  'bitlen':'1'}, 
 'm1_cache_wb':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0), 
  'pos':'18', 
  'bitlen':'1'}, 
 'm1_cache_wt':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0), 
  'pos':'19', 
  'bitlen':'1'}, 
 'm1_cache_way_dis':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0), 
  'pos':'20', 
  'bitlen':'4'}, 
 'm1_reserved':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 0), 
  'pos':'24', 
  'bitlen':'8'}, 
 'm1_image_address_offset':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 4), 
  'pos':'0', 
  'bitlen':'32'}, 
 'm1_boot_entry':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 8), 
  'pos':'0', 
  'bitlen':'32'}, 
 'm1_msp_val':{'offset':str(int(bootcpucfg_start_pos + bootcpucfg_len * bootcpucfg_m1_index) + 12), 
  'pos':'0', 
  'bitlen':'32'}, 
