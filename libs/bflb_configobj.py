    ...
    def walk(self, function, raise_errors=True, call_on_sections=False, **keywargs):
        ...
        for i in range(len(self.sections)):
            ...
            if call_on_sections:
                ...
                entry = self.sections[i]
            out[entry] = (self[entry].walk)(function, raise_errors=raise_errors, 
...
class ConfigObj(Section):
    ...
    def __init__(self, infile=None, options=None, configspec=None, encoding=None, interpolation=True, raise_errors=False, list_values=True, create_empty=False, file_error=False, stringify=True, indent_type=None, default_encoding=None, unrepr=False, write_empty_values=False, _inspec=False):
        ...
        if options is None:
            ...
            import warnings
            warnings.warn('Passing in an options dictionary to ConfigObj() is deprecated. Use **options instead.',
              DeprecationWarning,
              stacklevel=2)
    ...
    def _quote--- This code section failed: ---

 L.1721         0  LOAD_FAST                'multiline'
                2  POP_JUMP_IF_FALSE    22  'to 22'
                4  LOAD_DEREF               'self'
                6  LOAD_ATTR                write_empty_values
 ...
 L.1726        22  LOAD_FAST                'multiline'
               24  POP_JUMP_IF_FALSE   106  'to 106'
               26  LOAD_GLOBAL              isinstance
               28  LOAD_FAST                'value'
               30  LOAD_GLOBAL              list
               32  LOAD_GLOBAL              tuple
               34  BUILD_TUPLE_2         2 
               36  CALL_FUNCTION_2       2  '2 positional arguments'
               38  POP_JUMP_IF_FALSE   106  'to 106'

 L.1727        40  LOAD_FAST                'value'
 ...
 L.1730        60  LOAD_DEREF               'self'
               62  LOAD_ATTR                _quote
               64  LOAD_FAST                'value'
               66  LOAD_CONST               0
               68  BINARY_SUBSCR    
               70  LOAD_CONST               False
               72  LOAD_CONST               ('multiline',)
 ...
 L.1731        82  LOAD_STR                 ', '
               ...
               88  BUILD_TUPLE_1         1 
               90  LOAD_LISTCOMP            '<code_object <listcomp>>'
               92  LOAD_STR                 'ConfigObj._quote.<locals>.<listcomp>'
              ...
              104  RETURN_VALUE     
            106_0  COME_FROM            38  '38'
            106_1  COME_FROM            24  '24'

 L.1732       106  LOAD_GLOBAL              isinstance
              108  LOAD_FAST                'value'
              110  LOAD_GLOBAL              six
              112  LOAD_ATTR                string_types
              114  CALL_FUNCTION_2       2  '2 positional arguments'
              116  POP_JUMP_IF_TRUE    146  'to 146'

 L.1733       118  LOAD_DEREF               'self'
              120  LOAD_ATTR                stringify
              122  POP_JUMP_IF_FALSE   134  'to 134'

 L.1736       124  LOAD_GLOBAL              str
              126  LOAD_FAST                'value'
 ...
 L.1738       134  LOAD_GLOBAL              TypeError
              136  LOAD_STR                 'Value "%s" is not a string.'
              138  LOAD_FAST                'value'
              140  BINARY_MODULO    
              142  CALL_FUNCTION_1       1  '1 positional argument'
              144  RAISE_VARARGS_1       1  'exception instance'
            146_0  COME_FROM           132  '132'
            146_1  COME_FROM           116  '116'

 L.1740       146  LOAD_FAST                'value'
              148  POP_JUMP_IF_TRUE    154  'to 154'

 L.1741       150  LOAD_STR                 '""'
              152  RETURN_VALUE     
            154_0  COME_FROM           148  '148'

 L.1743       154  LOAD_DEREF               'self'
              156  LOAD_ATTR                list_values
              158  UNARY_NOT        
              160  JUMP_IF_FALSE_OR_POP   176  'to 176'
              162  LOAD_STR                 '\n'
              164  LOAD_FAST                'value'
              166  COMPARE_OP               not-in
              168  JUMP_IF_FALSE_OR_POP   176  'to 176'
              170  LOAD_STR                 '#'
              172  LOAD_FAST                'value'
              174  COMPARE_OP               not-in
            176_0  COME_FROM           168  '168'
            176_1  COME_FROM           160  '160'
              176  STORE_FAST               'no_lists_no_quotes'

 L.1744       178  LOAD_FAST                'multiline'
              180  JUMP_IF_FALSE_OR_POP   204  'to 204'
              182  LOAD_STR                 "'"
              184  LOAD_FAST                'value'
              186  COMPARE_OP               in
              ...
              192  LOAD_FAST                'value'
              194  COMPARE_OP               in
              196  JUMP_IF_TRUE_OR_POP   204  'to 204'
            ...
            204_1  COME_FROM           180  '180'
              204  STORE_FAST               'need_triple'

 L.1745       206  LOAD_FAST                'multiline'
              208  JUMP_IF_FALSE_OR_POP   238  'to 238'
              210  LOAD_FAST                'need_triple'
              212  UNARY_NOT        
              214  JUMP_IF_FALSE_OR_POP   238  'to 238'
              216  LOAD_STR                 "'"
              218  LOAD_FAST                'value'
              220  COMPARE_OP               in
              222  JUMP_IF_FALSE_OR_POP   238  'to 238'

 L.1746       224  LOAD_STR                 '"'
              226  LOAD_FAST                'value'
              228  COMPARE_OP               in
              230  JUMP_IF_FALSE_OR_POP   238  'to 238'
              232  LOAD_STR                 '#'
              234  LOAD_FAST                'value'
              236  COMPARE_OP               in
            238_0  COME_FROM           230  '230'
            238_1  COME_FROM           222  '222'
            238_2  COME_FROM           214  '214'
            238_3  COME_FROM           208  '208'
              238  STORE_FAST               'hash_triple_quote'

 L.1747       240  LOAD_FAST                'no_lists_no_quotes'
              242  POP_JUMP_IF_TRUE    252  'to 252'
              244  LOAD_FAST                'need_triple'
              246  UNARY_NOT        
          248_250  JUMP_IF_FALSE_OR_POP   256  'to 256'
            252_0  COME_FROM           242  '242'
              252  LOAD_FAST                'hash_triple_quote'
              254  UNARY_NOT        
            256_0  COME_FROM           248  '248'
              256  STORE_FAST               'check_for_single'

 L.1749       258  LOAD_FAST                'check_for_single'
          260_262  POP_JUMP_IF_FALSE   358  'to 358'

 L.1750       264  LOAD_DEREF               'self'
              266  LOAD_ATTR                list_values
          268_270  POP_JUMP_IF_TRUE    278  'to 278'

 L.1752       272  LOAD_GLOBAL              noquot
              274  STORE_FAST               'quot'
              276  JUMP_FORWARD        356  'to 356'
 ...
 L.1756       288  LOAD_GLOBAL              ConfigObjError
              290  LOAD_STR                 'Value "%s" cannot be safely quoted.'
              292  LOAD_FAST                'value'
              294  BINARY_MODULO    
              296  CALL_FUNCTION_1       1  '1 positional argument'
              298  RAISE_VARARGS_1       1  'exception instance'
              300  JUMP_FORWARD        356  'to 356'
            302_0  COME_FROM           284  '284'

 L.1757       302  LOAD_FAST                'value'
              304  LOAD_CONST               0
              306  BINARY_SUBSCR    
              308  LOAD_GLOBAL              wspace_plus
              310  COMPARE_OP               not-in
          312_314  POP_JUMP_IF_FALSE   346  'to 346'
              316  LOAD_FAST                'value'
              318  LOAD_CONST               -1
              320  BINARY_SUBSCR    
              322  LOAD_GLOBAL              wspace_plus
 ...
 L.1759       340  LOAD_GLOBAL              noquot
              342  STORE_FAST               'quot'
              344  JUMP_FORWARD        356  'to 356'
            346_0  COME_FROM           336  '336'
            346_1  COME_FROM           326  '326'
            346_2  COME_FROM           312  '312'

 L.1761       346  LOAD_DEREF               'self'
              348  LOAD_METHOD              _get_single_quote
              350  LOAD_FAST                'value'
              352  CALL_METHOD_1         1  '1 positional argument'
              354  STORE_FAST               'quot'
            356_0  COME_FROM           344  '344'
            356_1  COME_FROM           300  '300'
            356_2  COME_FROM           276  '276'
              356  JUMP_FORWARD        368  'to 368'
            358_0  COME_FROM           260  '260'

 L.1764       358  LOAD_DEREF               'self'
              360  LOAD_METHOD              _get_triple_quote
              362  LOAD_FAST                'value'
              364  CALL_METHOD_1         1  '1 positional argument'
              366  STORE_FAST               'quot'
            368_0  COME_FROM           356  '356'

 L.1766       368  LOAD_FAST                'quot'
              370  LOAD_GLOBAL              noquot
              372  COMPARE_OP               ==
          ...
          384_386  POP_JUMP_IF_FALSE   406  'to 406'
              388  LOAD_DEREF               'self'
              390  LOAD_ATTR                list_values
          392_394  POP_JUMP_IF_FALSE   406  'to 406'

 L.1767       396  LOAD_DEREF               'self'
              398  LOAD_METHOD              _get_single_quote
              400  LOAD_FAST                'value'
              402  CALL_METHOD_1         1  '1 positional argument'
              404  STORE_FAST               'quot'
            406_0  COME_FROM           392  '392'
            406_1  COME_FROM           384  '384'
            406_2  COME_FROM           374  '374'

 L.1769       406  LOAD_FAST                'quot'
              408  LOAD_FAST                'value'
              410  BINARY_MODULO    
              412  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `STORE_FAST' instruction at offset 256
    ...
    def _write_marker(self, indent_string, depth, entry, comment):
        ...
        return '%s%s%s%s%s' % (indent_string,
         self._a_to_u('[' * depth), self._quote((self._decode_element(entry)), multiline=False),
                ...
                if section is not self:
                    ...
                    if self.filename is None:
                        if outfile is None:
                            ...
                            elif not self.BOM or self.encoding is None or BOM_LIST.get(self.encoding.lower()) == 'utf_8':
                                if not out:
                                    out.append('')
    ...
    def validate(self, validator, preserve_errors=False, copy=False, section=None):
        ...
        for entry in configspec.scalars:
            if entry in ('__many__', '___many___'):
                continue
            elif entry not in section.scalars or entry in section.defaults:
                missing = True
                val = None
